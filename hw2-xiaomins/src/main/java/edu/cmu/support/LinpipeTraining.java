...
public class LinpipeTraining {
  ...
  public static void main(String[] args) throws IOException {
    File corpusFile = new File("./src/main/resources/data/medtag/genetag/genetag.tag");
    File modelFile = new File("./src/main/resources/data/medtag/genetag/trainedModle");
